...
RI.Data["Blacksmithing"] = {
	...
	[2740] = {
		creates = 2848,
		icon = "Interface\\Icons\\inv_mace_08",
		name = "Bronze Mace",
		reagents = {
			{
				itemID = 2841,
	...
	[3115] = {
		creates = 3239,
		icon = "Interface\\Icons\\inv_stone_weightstone_01",
	...
	[3117] = {
		creates = 3241,
		icon = "Interface\\Icons\\inv_stone_weightstone_03",
	...
	[3297] = {
		...
		reagents = {
			...
			{
				itemID = 3391,
				icon = "Interface\\Icons\\inv_potion_57",
				numRequired = 1,
			},
			{
				itemID = 1705,
	...
	[9921] = {
		creates = 7965,
		icon = "Interface\\Icons\\inv_stone_weightstone_04",
	...
	[9961] = {
		creates = 7931,
		icon = "Interface\\Icons\\inv_helmet_35",
		name = "Mithril Coif",
		reagents = {
			{
				itemID = 3860,
	...
	[9983] = {
		creates = 7955,
		icon = "Interface\\Icons\\inv_sword_21",
	...
	[10007] = {
		...
		reagents = {
			...
			{
				itemID = 3823,
				icon = "Interface\\Icons\\inv_potion_18",
				numRequired = 2,
			},
			{
				itemID = 7909,
	...
	[16643] = {
		creates = 12406,
		icon = "Interface\\Icons\\inv_belt_30",
		name = "Thorium Belt",
		reagents = {
			{
				itemID = 12359,
	...
	[16724] = {
		creates = 12633,
		icon = "Interface\\Icons\\inv_helmet_13",
		name = "Whitesoul Helm",
		reagents = {
			{
				itemID = 12359,
	...
	[29548] = {
		creates = 23487,
		icon = "Interface\\Icons\\inv_boots_chain_11",
	...
	[29549] = {
		creates = 23488,
		icon = "Interface\\Icons\\inv_pants_plate_18",
	...
	[29557] = {
		creates = 23497,
		icon = "Interface\\Icons\\inv_axe_11",
	...
	[29569] = {
		creates = 23504,
		icon = "Interface\\Icons\\inv_sword_12",
	...
	[29613] = {
		creates = 23512,
		icon = "Interface\\Icons\\inv_pants_plate_12",
	...
	[29620] = {
		creates = 23518,
		icon = "Interface\\Icons\\inv_pants_plate_06",
	...
	[29629] = {
		creates = 23523,
		icon = "Interface\\Icons\\inv_pants_plate_04",
		name = "Khorium Pants",
		reagents = {
			{
				itemID = 23449,
	...
	[29654] = {
		creates = 23528,
		icon = "Interface\\Icons\\inv_stone_sharpeningstone_06",
	...
	[29656] = {
		creates = 23529,
		icon = "Interface\\Icons\\inv_stone_sharpeningstone_07",
	...
	[29657] = {
		creates = 23530,
		icon = "Interface\\Icons\\inv_misc_armorkit_27",
	...
	[29700] = {
		creates = 23556,
		icon = "Interface\\Icons\\inv_mace_16",
	...
	[32655] = {
		creates = 25843,
		icon = "Interface\\Icons\\inv_rod_felsteel",
		name = "Fel Iron Rod",
		reagents = {
			{
				itemID = 23445,
	...
	[32656] = {
		creates = 25844,
		icon = "Interface\\Icons\\inv_rod_adamantite",
		name = "Adamantite Rod",
		reagents = {
			{
				itemID = 23446,
	...
	[32657] = {
		creates = 25845,
		icon = "Interface\\Icons\\inv_rod_eternium",
		name = "Eternium Rod",
		reagents = {
			{
				itemID = 23447,
	...
	[34533] = {
		creates = 28483,
		icon = "Interface\\Icons\\inv_chest_plate14",
	...
	[34535] = {
		creates = 28425,
		icon = "Interface\\Icons\\inv_sword_1h_blacksmithing_01",
		name = "Fireguard",
		reagents = {
			{
				itemID = 22456,
	...
	[34537] = {
		creates = 28426,
		icon = "Interface\\Icons\\inv_sword_1h_blacksmithing_02",
		name = "Blazeguard",
		reagents = {
			{
				itemID = 28425,
	...
	[34538] = {
		creates = 28428,
		icon = "Interface\\Icons\\inv_sword_2h_blacksmithing_01",
	...
	[34540] = {
		creates = 28429,
		icon = "Interface\\Icons\\inv_sword_2h_blacksmithing_02",
	...
	[34541] = {
		creates = 28431,
		icon = "Interface\\Icons\\inv_axe_1h_blacksmithing_01",
	...
	[34542] = {
		creates = 28432,
		icon = "Interface\\Icons\\inv_axe_1h_blacksmithing_02",
	...
	[34543] = {
		creates = 28434,
		icon = "Interface\\Icons\\inv_axe_50",
		name = "Lunar Crescent",
		reagents = {
			{
				itemID = 22451,
	...
	[34544] = {
		creates = 28435,
		icon = "Interface\\Icons\\inv_axe_51",
		name = "Mooncleaver",
		reagents = {
			{
				itemID = 28434,
	...
	[34545] = {
		creates = 28437,
		icon = "Interface\\Icons\\inv_mace_37",
	...
	[34546] = {
		creates = 28438,
		icon = "Interface\\Icons\\inv_mace_38",
		name = "Dragonmaw",
		reagents = {
			{
				itemID = 28437,
	...
	[34547] = {
		creates = 28440,
		icon = "Interface\\Icons\\inv_mace_2h_blacksmithing_01",
		name = "Thunder",
		reagents = {
			{
				itemID = 22451,
	...
	[34548] = {
		creates = 28441,
		icon = "Interface\\Icons\\inv_mace_2h_blacksmithing_02",
		name = "Deep Thunder",
		reagents = {
			{
				itemID = 28440,
	...
	[34607] = {
		creates = 28420,
		icon = "Interface\\Icons\\inv_stone_weightstone_06",
	...
	[34608] = {
		creates = 28421,
		icon = "Interface\\Icons\\inv_stone_weightstone_07",
	...
	[34982] = {
		creates = 29203,
		icon = "Interface\\Icons\\inv_weapon_shortblade_26",
	...
	[36125] = {
		creates = 30071,
		icon = "Interface\\Icons\\inv_sword_draenei_01",
	...
	[36126] = {
		creates = 30072,
		icon = "Interface\\Icons\\inv_axe_67",
	...
	[36128] = {
		creates = 30073,
		icon = "Interface\\Icons\\inv_hammer_21",
	...
	[36133] = {
		creates = 30086,
		icon = "Interface\\Icons\\inv_sword_37",
	...
	[36134] = {
		creates = 30087,
		icon = "Interface\\Icons\\inv_axe_39",
	...
	[36258] = {
		creates = 28427,
		icon = "Interface\\Icons\\inv_sword_1h_blacksmithing_03",
		name = "Blazefury",
		reagents = {
			{
				itemID = 28426,
	...
	[36259] = {
		creates = 28430,
		icon = "Interface\\Icons\\inv_sword_2h_blacksmithing_03",
	...
	[36260] = {
		creates = 28433,
		icon = "Interface\\Icons\\inv_axe_1h_blacksmithing_03",
	...
	[36261] = {
		creates = 28436,
		icon = "Interface\\Icons\\inv_axe_52",
		name = "Bloodmoon",
		reagents = {
			{
				itemID = 28435,
	...
	[36263] = {
		creates = 28442,
		icon = "Interface\\Icons\\inv_mace_2h_blacksmithing_03",
		name = "Stormherald",
		reagents = {
			{
				itemID = 28441,
	...
	[36392] = {
		creates = 30031,
		icon = "Interface\\Icons\\inv_boots_chain_04",
	...
	[41135] = {
		creates = 32573,
		icon = "Interface\\Icons\\inv_shoulder_66",
	...
	[42662] = {
		creates = 33173,
		icon = "Interface\\Icons\\inv_shoulder_16",
	...
	[43846] = {
		creates = 32854,
		icon = "Interface\\Icons\\inv_mace_41",
	...
	[52567] = {
		creates = 39086,
		icon = "Interface\\Icons\\inv_pants_plate_03",
	...
	[52570] = {
		creates = 39085,
		icon = "Interface\\Icons\\inv_chest_plate09",
	...
	[52572] = {
		creates = 39083,
		icon = "Interface\\Icons\\inv_shoulder_31",
	...
	[54550] = {
		creates = 40668,
		icon = "Interface\\Icons\\inv_shield_46",
	...
	[54555] = {
		creates = 40673,
		icon = "Interface\\Icons\\inv_helmet_123",
	...
	[54556] = {
		creates = 40675,
		icon = "Interface\\Icons\\inv_shoulder_70",
	...
	[54557] = {
		creates = 40670,
		icon = "Interface\\Icons\\inv_shield_45",
	...
	[55174] = {
		creates = 41181,
		icon = "Interface\\Icons\\inv_axe_87",
	...
	[55177] = {
		creates = 41182,
		icon = "Interface\\Icons\\inv_sword_111",
	...
	[55179] = {
		creates = 41183,
		icon = "Interface\\Icons\\inv_weapon_shortblade_68",
	...
	[55182] = {
		creates = 41185,
		icon = "Interface\\Icons\\inv_mace_69",
	...
	[55185] = {
		creates = 41188,
		icon = "Interface\\Icons\\inv_mace_63",
	...
	[55187] = {
		creates = 41190,
		icon = "Interface\\Icons\\inv_pants_plate_02",
	...
	[55200] = {
		creates = 41239,
		icon = "Interface\\Icons\\inv_sword_94",
	...
	[55203] = {
		creates = 41242,
		icon = "Interface\\Icons\\inv_sword_96",
	...
	[55204] = {
		creates = 41243,
		icon = "Interface\\Icons\\inv_axe_88",
	...
	[55306] = {
		creates = 41351,
		icon = "Interface\\Icons\\inv_shoulder_92",
	...
	[55369] = {
		creates = 41257,
		icon = "Interface\\Icons\\inv_mace_84",
	...
	[55370] = {
		creates = 41383,
		icon = "Interface\\Icons\\inv_mace_87",
	...
	[55372] = {
		creates = 41386,
		icon = "Interface\\Icons\\inv_helmet_134",
	...
	[55656] = {
		creates = 41611,
		icon = "Interface\\Icons\\inv_belt_36",
	...
	[55835] = {
		creates = 41975,
		icon = "Interface\\Icons\\inv_gauntlets_09",
	...
	[56234] = {
		creates = 42435,
		icon = "Interface\\Icons\\inv_weapon_shortblade_76",
	...
	[56280] = {
		creates = 42443,
		icon = "Interface\\Icons\\inv_mace_67",
	...
	[56357] = {
		creates = 42500,
		icon = "Interface\\Icons\\inv_titanium_shield_spike",
	...
	[59440] = {
		creates = 43865,
		icon = "Interface\\Icons\\inv_shoulder_71",
	...
	[59441] = {
		creates = 43870,
		icon = "Interface\\Icons\\inv_helmet_105",
	...
	[62202] = {
		creates = 44936,
		icon = "Interface\\Icons\\inv_shield_19",
	...
	[63182] = {
		creates = 45085,
		icon = "Interface\\Icons\\inv_sword_73",
	...
	[67133] = {
		creates = 47573,
		icon = "Interface\\Icons\\inv_bracer_26b",
		name = "Titanium Spikeguards",
		reagents = {
			{
				itemID = 37663,
