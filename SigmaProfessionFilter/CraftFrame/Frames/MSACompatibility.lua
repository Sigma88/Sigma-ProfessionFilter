...
function SPF1.DropDownMenu_SetWidth(width, frame)
...
function SPF1.DropDownMenu_SetSelectedID(frame, id, useValue)
...
function SPF1.DropDownMenu_Initialize(frame, initFunction, displayMode, level)
...
function SPF1.DropDownMenu_AddButton(info, level)
